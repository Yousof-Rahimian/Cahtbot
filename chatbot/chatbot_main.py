...
import chatbot_training as trainpyche
...
class ChatBot:
    ...
    def main_window(self):
        ...
        self.window.title("Virtula Facility Service")
        ...
        self.tab.add(self.bot_frame, text='Virtula Facility Service Bot'.center(100))
    ...
    def add_bot(self):
        ...
        head_label = Label(self.bot_frame, bg = BG_COLOR, fg = TEXT_COLOR, 
                            text = "Welcome to Virtula Facility Service Chatbot", font = FONT_BOLD, pady = 10)
        ...
        self.text_widget.insert(END, "Ibot: Welcome to Virtula Facility Service Chatbot\nI will try to answer all your questions about your Property.\n\n")
